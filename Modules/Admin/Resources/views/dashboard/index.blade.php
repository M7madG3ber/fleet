...
<div class="grid clearfix">
    <div class="row">
        ...
        {{-- @include('admin::dashboard.grids.ratePendingCompleted') --}}
        @endHasAccess
    ...
    <div class="row">
        @hasAccess('admin.orders.index')
        @include('admin::dashboard.grids.completed')
        @include('admin::dashboard.grids.completedSales')
        @include('admin::dashboard.grids.rateCompleted')
        @endHasAccess
    </div>
    <div class="row">
        @hasAccess('admin.orders.index')
        @include('admin::dashboard.grids.pending')
        @include('admin::dashboard.grids.pendingSales')
        @include('admin::dashboard.grids.ratePending')
        @endHasAccess
    </div>
</div>
